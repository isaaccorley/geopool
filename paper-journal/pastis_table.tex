\begin{table}[!htbp]
  ...
  \footnotesize
  \caption{PASTIS results (F1-macro, \%): linear and kNN ($k{=}5$) probes per encoder. Best per column in \textbf{bold}, second-best in \textit{italics}. \colorbox{blue!10}{\strut Mean+Std} highlighted as the recommended method for variable-size regions. OE\,=\,OlmoEarth-Nano; Tess\,=\,Tessera.}\label{tab:pastis}
