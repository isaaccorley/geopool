\begin{table*}[!tb]
  ...
  \footnotesize
  \caption{EuroSAT results (accuracy, \%): linear and kNN ($k{=}5$) probes under random and spatial splits. Best per column in \textbf{bold}, second-best in \textit{italics}. Dim\,=\,output embedding size relative to encoder dimension $D$. \colorbox{green!10}{\strut Stats} highlighted as the recommended method in the $N{\gg}D$ regime. $^*$OlmoEarth-Nano; OE\,=\,OlmoEarth; Tess\,=\,Tessera.}\label{tab:eurosat}
