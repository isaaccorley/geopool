...
subtitle: "Pooling Strategies for Earth Embeddings — ICLR 2026 | ML4RS Workshop"
...
![](../slides/figures/patch_vs_pixel.png){height="450px"}
:::
...
::: {style="text-align: center;"}
![](../slides/figures/resolution_mismatch.png){width="85%"}
:::
...
Mean pooling ($\mu$, red) misses this signal.
:::
...
```{=html}
<div style="display: flex; align-items: center; justify-content: center; gap: 1em; margin: 1em auto;">
  <div style="background: rgba(27,79,114,0.08); border: 2px solid #1B4F72; border-radius: 8px; padding: 0.6em 1.2em; text-align: center; font-size: 0.9em;">
    <strong>3 encoders</strong>
  </div>
  <div style="font-size: 1.5em; color: #1B4F72;">→</div>
  <div style="background: rgba(27,79,114,0.08); border: 2px solid #1B4F72; border-radius: 8px; padding: 0.6em 1.2em; text-align: center; font-size: 0.9em;">
    <strong>13 pooling<br/>methods</strong>
  </div>
  <div style="font-size: 1.5em; color: #1B4F72;">→</div>
  <div style="background: rgba(27,79,114,0.08); border: 2px solid #1B4F72; border-radius: 8px; padding: 0.6em 1.2em; text-align: center; font-size: 0.9em;">
    <strong>2 probes</strong><br/><span style="font-size: 0.8em;">kNN | Linear</span>
  </div>
  <div style="font-size: 1.5em; color: #1B4F72;">→</div>
  <div style="background: rgba(27,79,114,0.08); border: 2px solid #1B4F72; border-radius: 8px; padding: 0.6em 1.2em; text-align: center; font-size: 0.9em;">
    <strong>2 splits</strong><br/><span style="font-size: 0.8em;">Random | Spatial</span>
  </div>
</div>
```
...
::: {style="text-align: center; font-size: 1.4em; font-weight: bold; margin: 0.5em 0;"}
= 156 experiments
:::
...
On random splits, differences shrink to 3--5% (spatial leakage flatters everyone). The spatial split is the honest evaluation.
:::
...
::: {style="text-align: center;"}
![](../paper/figures/performance_comparison.png){height="380px"}
:::
...
BoVW hits 92.3% (linear) but fails on other encoders. Compact embeddings are naturally more robust to shift.
:::

::: {.column width="30%"}
**OlmoEarth** (128-d)

Std alone boosts kNN by +11% over mean. Second-order stats help similarity search more than linear probes.
:::

::: {.column width="30%"}
**Tessera** (512-d)

Covariance pooling excels at kNN. Largest mean-pooling gap (12%). High-dim benefits most from stats.
:::
...
| Best accuracy | Stats [min/max/$\mu$/$\sigma$] | +7--10% | 4× |
...
::: {.column width="40%"}
![](../slides/qr_code.png){width="70%"}

Code
:::

::: {.column width="40%"}
![](../slides/qr_data.png){width="70%"}
