...
institute: "¹Wherobots · ²Microsoft AI for Good Research Lab<br/>ICLR 2026 | ML4RS Workshop"
date: ""
format:
  revealjs:
...
::: {.column width="44%"}
![](../paper/figures/hero.png){width="100%"}
:::
...
%%| fig-width: 10
flowchart LR
    A["3 encoders"] --> B["13 pooling<br/>methods"]
    B --> C["2 probes<br/>kNN | Linear"]
    C --> D["2 splits<br/>Random | Spatial"]
```
